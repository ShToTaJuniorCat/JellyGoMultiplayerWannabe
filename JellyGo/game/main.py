...
#         tower.send_jellies(amount)
#
#     # Display jelly sending animation
#     print("Display sending animation")
#
#     # Call an internal JellyBubble method along with an internal JellyTower method to figure
#     # out the expected behavior of the jelly on the tower
#
#
...
#             print(obst.collides_with_obstacle(pygame.mouse.get_pos()))
...
obst1 = Obstacle([(100, 100), (100, 200), (200, 100), (200, 50), (702.3, 509.2)], RED)
left_wall = Obstacle([(-10, -10), (0, -10), (0, SCREEN_HEIGHT + 10), (-10, SCREEN_HEIGHT + 10)], BLACK)
bottom_wall = Obstacle([(-10, SCREEN_HEIGHT), (-10, SCREEN_HEIGHT + 10),
                        (SCREEN_WIDTH + 10, SCREEN_HEIGHT + 10), (SCREEN_WIDTH + 10, SCREEN_HEIGHT)], BLACK)
right_wall = Obstacle([(SCREEN_WIDTH, SCREEN_HEIGHT + 10), (SCREEN_WIDTH + 10, SCREEN_HEIGHT + 10),
                       (SCREEN_WIDTH + 10, -10), (SCREEN_WIDTH, -10)], BLACK)
top_wall = Obstacle([(-10, -10), (SCREEN_WIDTH + 10, -10), (SCREEN_WIDTH + 10, 0), (-10, 0)], BLACK)

pathfind = Pathfinder((100, 100), (101, 101), [left_wall, bottom_wall, right_wall, top_wall])
print(pathfind.find_path())
